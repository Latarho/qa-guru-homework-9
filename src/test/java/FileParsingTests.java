...
public class FileParsingTests {
    ...
    private static final String ZIP_FILE_PATH = "src/test/resources/files/zip_for_tests.zip";

    public ZipFile unZip(String zipFilePath) throws IOException {
    ...
    @Test
    public void verifyCsv() throws Exception {
    ...
    // Как можно улучшить?
    @Test
    public void verifyXlsx() throws Exception {
